...
const SettingsPage = () => {
  ...
  const handleResetOnboarding = () => {
    ...
    const confirmed = window.confirm(
      'Are you sure you want to reset your onboarding preferences? This will show the cloud storage setup page again the next time you log in.'
    );
    
    if (confirmed) {
      userPreferencesService.resetPreferences(user.id);
      alert('Onboarding preferences reset successfully. You will see the setup page again on your next login.');
    }
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="lg:col-span-3">
              <div className="bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-700">
                ...
                {/* Billing Settings */}
                {activeTab === 'billing' && (
                  <BillingManager showHeader={true} compact={true} />
                )}
