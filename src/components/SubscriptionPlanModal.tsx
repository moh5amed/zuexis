            ...
            <div className="p-6">
              ...
              <StripeCheckout
                ...
                onSuccess={() => {
                  ...
                  setTimeout(() => {
                    // Call the onPlanSelected callback which should refresh the parent component
                    onPlanSelected(selectedPlan);
                    
                    // Close the modal
                    onClose();
                    
                    // Trigger a custom event to refresh subscription data
                    window.dispatchEvent(new CustomEvent('subscription-updated', {
                      detail: { planSlug: selectedPlan }
                    }));
                  }, 2000);
                }}
